        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#111111;border-radius:12px;overflow:hidden;border:1px solid #C0392B;">
          ...
          <tr>
            <td style="background:#C0392B;padding:24px;text-align:center;">
              ...
              <h1 style="margin:8px 0 0;font-size:24px;font-weight:900;color:#ffffff;letter-spacing:-0.02em;">NEW ORDER SECURED 💰</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 24px;font-size:16px;color:#cccccc;line-height:1.6;">Someone just paid for our snark. Let's get to work.</p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border-radius:8px;border:1px solid #2a2a2a;">
                <tr><td style="padding:24px;">
                  ...
                  <p style="margin:0;font-size:15px;color:#cccccc;">💳 <strong style="color:#ffffff;">Total Amount:</strong> $${totalAmount.toFixed(2)}</p>
                </td></tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 40px 32px;text-align:center;">
              <p style="margin:0;font-size:14px;color:#666666;font-style:italic;">Stay snarky. The money printer goes brrr.</p>
            </td>
          </tr>
        </table>
      </td>
