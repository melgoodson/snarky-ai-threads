-- September / Q3 2026 Featured Designs SQL Seed Script
-- Includes: Labor Day, Grandparents Day, 9/11 Patriot Day, Hispanic Heritage Month

-- 1. Insert 19 new Q3 designs into the `designs` table
...
-- 2. Upsert Month 8 (September) Featured Schedule in `featured_schedules`
INSERT INTO featured_schedules (month, headline, subheadline, themes, is_active)
VALUES (
  8,
  'Q3 HOLIDAYS & ATTITUDE',
  'Labor Day, Grandparents Day, 9/11 Patriot Remembrance, & Hispanic Heritage Month — snarky apparel for every September event.',
  '[
