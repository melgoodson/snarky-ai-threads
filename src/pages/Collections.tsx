...
const PERSONALIZED_COLLECTIONS = [
  ...
  { name: "Personalized Notebook Gifts", slug: "/category/personalized-notebook-gifts", emoji: "📓", description: "Custom hardcover journals and personalized notebooks", keywords: "personalized notebook gifts, custom hardcover journals" },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.snarkyhumans.com/collections" />
      </Helmet>
      <Header />
        ...
        <section className="py-12 md:py-20">
          <div className="container px-4">
            ...
            <CollectionSilo
              ...
              subtitle="Browse by product type — shirts, hoodies, journals, mugs, totes, and greeting cards."
